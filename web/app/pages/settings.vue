<template>
  <div class="max-w-4xl mx-auto space-y-6">
    <!-- Header -->
    <div class="glass-card border-2 border-purple-200">
      <div class="flex items-center gap-4">
        <div class="w-16 h-16 bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl flex items-center justify-center shadow-lg">
    ...
    <div class="glass-card glass-hover">
      ...
      <div v-if="userData" class="flex items-center gap-6">
        <div class="relative group">
          <div class="absolute inset-0 bg-gradient-to-r from-purple-600 to-blue-600 rounded-full blur-md group-hover:blur-lg transition-all"></div>
          <img
            v-if="userData.avatar"
            :src="userData.avatar"
            :alt="userData.name"
            class="relative h-20 w-20 rounded-full object-cover ring-4 ring-white shadow-xl"
          />
        </div>
        <div class="flex-1">
    ...
    <!-- API Key Section -->
    <div class="glass-card glass-hover border-2 border-purple-200">
      <div class="flex items-start gap-3 mb-4">
        <div class="w-10 h-10 bg-gradient-to-r from-purple-600 to-blue-600 rounded-xl flex items-center justify-center flex-shrink-0">
      ...
      <div class="space-y-3">
        <div class="relative">
          <input
            ...
            readonly
            class="w-full px-4 py-3 glass rounded-xl font-mono text-sm text-purple-700 border-2 border-purple-200 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all"
          />
        </div>
        ...
        <div class="flex gap-2">
          ...
          >
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path v-if="!showKey" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
              <path v-if="!showKey" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
      ...
      <div class="space-y-6">
        ...
        <div class="flex gap-4">
          <div class="flex-shrink-0">
            <div class="w-8 h-8 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-full flex items-center justify-center font-bold text-sm shadow-lg">
              1
            </div>
          </div>
          <div class="flex-1">
            <h3 class="font-semibold text-gray-900 mb-2">Login with the CLI</h3>
            <code class="block glass px-4 py-3 rounded-lg text-sm font-mono text-purple-700 border border-purple-200">
